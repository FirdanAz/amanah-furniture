...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    return _isLoad
        ? Scaffold(
            body: Center(
              child: CircularProgressIndicator(color: ColorApp.accent),
            ),
          )
        : Scaffold(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            ApiService().postKeranjang(
                                context: context,
                                barang_id: item.id!.toString(),
                                nama_barang: item.namaBarang!.toString(),
                                harga: item.harga!.toString(),
                                jumlah: '1',
                                total_harga: item.harga!.toString(),
                                gambarBarang: item.gambarBarang.toString());
                          },
                          child: SizedBox(
                            height: 40,
                            width: 40,
                            child: Ink(
                              ...
                              child: Padding(
                                ...
                                child:
                                    SvgPicture.asset(SvgAssets.vectorKeranjang),
                              ),
                            ),
                          ),
                        )
            ...
            body: CustomScrollView(
              slivers: [
                SliverAppBar(
                  ...
                  expandedHeight: 330,
                  systemOverlayStyle:
                      SystemUiOverlayStyle(statusBarColor: ColorApp.secondary),
                  elevation: 0,
                  backgroundColor: Colors.blue,
                  leading: InkWell(
                    child:
                        Icon(Icons.arrow_back_ios_new, color: ColorApp.accent),
