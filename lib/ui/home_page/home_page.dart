                        ...
                        child: Row(
                          ...
                          children: [
                              ...
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color: Colors.black.withOpacity(0.05), borderRadius: BorderRadius.circular(7)),
                                  child: Row(
                                    children: [
                                      Icon(Icons.search,
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(10),
                                child: SvgPicture.asset(SvgAssets.vectorKeranjang),
                              ),
                            )
                          ],
                        ),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      margin: EdgeInsets.fromLTRB(14*fem, 0*fem, 14*fem, 20*fem),
                      width: double.infinity,
                      height: 120*fem,
                      child: Container(
                        child: Stack(
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              top: 0*fem,
                              child: Container(
                                padding: EdgeInsets.fromLTRB(3.39*fem, 16.41*fem, 3.39*fem, 12.84*fem),
                                width: 83*fem,
                                height: 105*fem,
                                decoration: BoxDecoration (
